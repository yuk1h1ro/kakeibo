...
//   - 端末ごとにずれても、いつ鳴るかが多少変わるだけで通知そのものは止まらない。
//     (通知先の Discord Webhook URL は、設定した端末からしか通知が飛ばないという
//      事故が実際に起きたため、discord_settings で端末間で同期している。
//      止まると困る度合いが違うので、ここは端末ごとのままにしてある)
