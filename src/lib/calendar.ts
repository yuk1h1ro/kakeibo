...
//
// (以前ここに「format.ts は変更禁止のためここに置く」と書いてあったが、これは
//  54機能を並行実装していた時期の一時的な取り決めで、既に失効している。
//  format.ts はその後 543b2d3 で実際に改変されており、日付の計算をこちらに
//  集めるにあたって format.monthKeyOffset も畳んだ。禁止は生きていない)
